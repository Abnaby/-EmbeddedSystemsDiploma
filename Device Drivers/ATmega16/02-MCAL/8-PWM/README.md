...
|PWM_voidSetOCPin(PWM_config_t *,PWM_OC_Pin )|This Function Used to set Function of OC Pin.|`PWM_config_t *ptr_userConfig` pointer to struct that holds <a href="#PWM-Configuration">user configuration</a> <br/> `PWM_OC_Pin setOCpinMode`  select  Mode from<a href="#PWM-OC_PIN">@ref PWM_OC_Pin</a>  |`void`| Must Make Corresponding Pin As Output from GPIO Driver|
...
|PWM_voidPhaseFrequencyCorrectSetValues(PWM_config_t* , u8  , u8 )|This Function Used To Set Phase_Freq Parameters TOP,COMP Values.|`PWM_config_t *ptr_userConfig` pointer to struct that holds <a href="#PWM-Configuration">user configuration</a> <br/> `u16 copy_u16TopValue`  Set Frequency of Wave From 0--> (2^16)-1  <br/> `u16 copy_u16CompValue` Set Duty Cycle of wave by setting compare value  |`void`|Only With Timer1/PWM1| 
