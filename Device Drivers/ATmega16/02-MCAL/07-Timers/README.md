...
|Timer_voidInitTimer2(Timer2Config_t)|This Function Used to Init Timer2 Only|`Timer2Config_t *ptr_userConfig` pointer to struct that holds <a href="#Timer2-Configuration">user configuration for timer0</a>  |`void`|| 
|Timer_voidStartTimer(TimerSelection_t)|This Function Used to Start Timerx for counting|`TimerSelection_t copyTimerIndex` select from @ref  <a href="#TIM-Selection">@ref TimerSelection_t enum</a> |`void`|| 
|Timer_voidStopTimer(TimerSelection_t)|This Function Used to Stop Timerx from Counting and clear Counter|`TimerSelection_t copyTimerIndex` select from @ref  <a href="#TIM-Selection">@ref TimerSelection_t enum</a> |`void`|| 
|Timer_u8GetCounterTimer(TimerSelection_t,u8*)|This function used to get number of ticks from when i start timer|`TimerSelection_t copyTimerIndex` select from @ref  <a href="#TIM-Selection">@ref TimerSelection_t enum</a> <br/>`u8 *pu8GetTicks` This function used to get number of ticks from when start timer. |`void`||
 |Timer_u8SetCounterTimer(TimerSelection_t,u8)|This function used to set number of ticks to start count from it.|`TimerSelection_t copyTimerIndex` select from @ref  <a href="#TIM-Selection">@ref TimerSelection_t enum</a> <br/> `u8 copy_u8SetTicks` number of ticks will loaded into TCNTx reg. |`void`|Normally used with `Normal Mode` to set init value of `TCNTx`|
...
| Parameter Name | Usage |  Ref to its enum |
| ------ | ------ |  ------ | 
|clkSourceOfTimer2| Select Timer 2 Clock Source |See <a href="#TIM2_ClockSource">@ref</a>  | 
|clkSourceAndPrescalerTimer2  | Select Clock Source with Prescaler for Timer 2 | See <a href="#TIM2_ClockSelect">@ref</a> | 
|operationModeTIM2  | Select Clock Source with Prescaler for Timer 2 | See <a href="#TIM-OpModes">@ref</a> | 
