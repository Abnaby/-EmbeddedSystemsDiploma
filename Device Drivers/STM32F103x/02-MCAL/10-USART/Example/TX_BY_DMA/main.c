...
DMA_Config_t DMA0_tx = {CHANNEL4 ,DMA_HIGH , DISABLE_CIRCULAR , MEM_TO_PERI , BYTE ,BYTE  , MEM_INCREMENT_ENABLE ,PERIPHERAL_INCREMENT_DISABLE ,
...
int main(void){
	...
	/******************* NVIC	**********************************/
	NVIC_voidEnableInterrupt(14);	/* DMA1 CH4*/
	...
	myUART.USART_DMA =DMA_TX_ENABLE ;
	...
	DMA_voidStatrTransfer(CHANNEL4,DMA_address , arr, 200, DMA_Finished) ;
