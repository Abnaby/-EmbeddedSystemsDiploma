...
{
	SPI_DMA_DISABLE = 0	,
	SPI_DMA_TX_ENABLE	= (1<<1),
	SPI_DMA_RX_ENABLE	= (1<<0),
	SPI_DMA_TX_RX_ENABLE = ((1<<0) | (1<<1) )
...
/**
 * @brief 			- Get DMA DR Reg Address
 * @param [in] 		- SPI_Number : where x can be (1,2 depending on device used)
 * @param [in] 		- ptr_u32PeripheralAddress : Pointer to Address of DR Reg)
 * @retval 			- None
 * Note				- None
 */
void SPI_voidGetDMA_PeripheralAddress(SPI_Select_t SPI_Number , u32* ptr_u32PeripheralAddress);
